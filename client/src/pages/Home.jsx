...
const Home = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto text-[#601818]">
            <div>
                <h1 className="font-extrabold  text-[32px]">The Community Showcase</h1>

                <p className="mt-2 text-[#000409] text-[16px] max-w[500px]">Browse through a collection of imaginative and visually stunning images generated by ImageCraft AI </p>
            </div>
